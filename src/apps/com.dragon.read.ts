      ...
      rules: [
        {
          ...
          activityIds: 'com.ss.android.excitingvideo.ExcitingVideoActivity',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/bmj"] > android.widget.FrameLayout[id="com.dragon.read:id/bmm"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout > com.lynx.tasm.behavior.ui.LynxFlattenUI[desc="继续观看"][text="继续观看"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.dragon.read:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/ail"] > android.widget.LinearLayout[id="com.dragon.read:id/aik"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.dragon.read:id/aic"] > android.widget.FrameLayout > com.lynx.tasm.behavior.ui.view.UIView[desc="立即签到 +3066 金币"][text="立即签到 +3066 金币"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '.pages.main.MainFragmentActivity',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.dragon.read:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/ail"] > android.widget.LinearLayout[id="com.dragon.read:id/aik"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.dragon.read:id/aic"] > android.widget.FrameLayout > com.lynx.tasm.behavior.ui.LynxFlattenUI[desc="立即领取"][text="立即领取"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '.pages.main.MainFragmentActivity',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.dragon.read:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/ail"] > android.widget.LinearLayout[id="com.dragon.read:id/aik"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.dragon.read:id/aic"] > android.widget.FrameLayout > com.lynx.tasm.behavior.ui.view.UIView[desc="立即签到 +1088 金币"][text="立即签到 +1088 金币"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.LinearLayout > android.view.ViewGroup > android.widget.TextView[id="com.dragon.read:id/fhm"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[clickable=true] > android.widget.FrameLayout > android.view.ViewGroup[id="com.dragon.read:id/ne"][clickable=true] > android.widget.LinearLayout[id="com.dragon.read:id/cxj"] > android.widget.TextView[id="com.dragon.read:id/bd7"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
