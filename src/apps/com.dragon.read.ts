      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.LinearLayout[id="com.dragon.read:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/root_view"] > android.widget.FrameLayout[id="com.dragon.read:id/dtq"] > android.widget.FrameLayout > com.dragon.reader.simple.slip.HorizontalAndVerticalScrollView[id="com.dragon.read:id/dip"] > android.widget.FrameLayout[id="com.dragon.read:id/bw6"] > android.widget.FrameLayout[id="com.dragon.read:id/dqe"] > android.view.ViewGroup[id="com.dragon.read:id/bw5"] > android.widget.FrameLayout[clickable=true] > android.widget.FrameLayout[id="com.dragon.read:id/dth"] > android.widget.FrameLayout > android.widget.FrameLayout > android.view.ViewGroup > android.widget.FrameLayout[id="com.dragon.read:id/b8a"] > android.widget.FrameLayout > android.widget.FrameLayout > android.view.ViewGroup[id="com.dragon.read:id/root_layout"] > android.widget.LinearLayout[id="com.dragon.read:id/b63"] > android.widget.FrameLayout > android.view.ViewGroup > android.view.View[id="com.dragon.read:id/aw3"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: 'com.ss.android.excitingvideo.ExcitingVideoActivity',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/bmj"] > android.widget.FrameLayout[id="com.dragon.read:id/bmm"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout > com.lynx.tasm.ui.image.UIImage[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.view.ViewGroup > android.view.ViewGroup[id="com.dragon.read:id/n6"] > android.widget.LinearLayout > android.widget.TextView[id="com.dragon.read:id/bd7"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '.pages.main.MainFragmentActivity',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.LinearLayout[id="com.dragon.read:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/root_layout"] > android.widget.FrameLayout[id="com.dragon.read:id/bvu"] > android.widget.FrameLayout[id="com.dragon.read:id/fragment_container"] > android.widget.FrameLayout[id="com.dragon.read:id/g0_"] > androidx.viewpager.widget.ViewPager[id="com.dragon.read:id/aax"] > android.widget.FrameLayout[id="com.dragon.read:id/bvs"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.dragon.read:id/eok"] > android.widget.FrameLayout[id="com.dragon.read:id/d_p"] > android.widget.FrameLayout[id="com.dragon.read:id/bjk"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout > com.lynx.tasm.behavior.ui.LynxFlattenUI[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: 'com.ss.android.excitingvideo.ExcitingVideoActivity',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/bmj"] > android.widget.FrameLayout[id="com.dragon.read:id/bmm"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout > com.lynx.tasm.behavior.ui.view.UIView[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '.plugin.live.web.OpenLiveWebViewActivity',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.LinearLayout[id="com.dragon.read:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read.plugin.live:id/ttlive_bottom_sheet_container"] > android.view.ViewGroup[id="com.dragon.read.plugin.live:id/ttlive_coordinator"] > android.widget.FrameLayout[id="com.dragon.read.plugin.live:id/ttlive_design_bottom_sheet"] > android.widget.RelativeLayout[id="com.dragon.read:id/root_layout"] > android.view.ViewGroup[id="com.dragon.read.plugin.live:id/hybridContainer"][clickable=true] > android.widget.FrameLayout[id="com.dragon.read.plugin.live:id/realHybridContainer"] > android.view.ViewGroup[id="com.dragon.read.plugin.live:id/annie_fragment_root_view"] > android.widget.FrameLayout[id="com.dragon.read.plugin.live:id/hybrid_view_container"] > android.widget.FrameLayout > android.widget.FrameLayout > com.lynx.tasm.behavior.ui.view.UIView[desc="身份证按钮"][text="身份证按钮"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout > android.widget.LinearLayout > android.widget.LinearLayout[id="com.dragon.read:id/frj"] > android.widget.TextView[id="com.dragon.read:id/frk"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.dragon.read:id/brv"] > android.widget.FrameLayout[id="com.dragon.read:id/be5"] > android.view.ViewGroup[id="com.dragon.read:id/b8l"][clickable=true] > android.widget.ImageView[id="com.dragon.read:id/cjo"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
