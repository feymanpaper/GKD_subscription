      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.RelativeLayout > android.view.ViewGroup > android.widget.TextView[id="com.wjkj.loosrun:id/dialogPermissionsHintContentImNot"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
