      ...
      rules: [
        {
          ...
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fragment_container"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.RelativeLayout[id="com.autonavi.minimap:id/mapInteractiveRelativeLayout"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true]',
      ...
      rules: [
        {
          ...
          activityIds: 'com.autonavi.map.activity.NewMapActivity',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fragment_container"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.RelativeLayout[id="com.autonavi.minimap:id/mapInteractiveRelativeLayout"][clickable=true] > android.widget.RelativeLayout[clickable=true] > android.widget.FrameLayout[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: 'com.autonavi.map.activity.NewMapActivity',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fragment_container"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.RelativeLayout[clickable=true] > android.widget.FrameLayout[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fragment_container"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/parentPanel"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/buttonPanel"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/button_container"][clickable=true] > android.widget.Button[id="com.autonavi.minimap:id/button3"][text="设置"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: 'com.autonavi.map.activity.NewMapActivity',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fragment_container"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.RelativeLayout[clickable=true] > android.widget.FrameLayout[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.widget.LinearLayout[clickable=true] > android.support.v7.widget.RecyclerView[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.widget.ImageView[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: 'com.autonavi.map.activity.NewMapActivity',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fragment_container"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.RelativeLayout[id="com.autonavi.minimap:id/mapInteractiveRelativeLayout"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.widget.ImageView[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: 'com.autonavi.map.activity.NewMapActivity',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fragment_container"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.FrameLayout[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > com.autonavi.minimap.ajx3.widget.view.SpringScrollView[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.ViewGroup[clickable=true] > android.view.View[text="保存"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fragment_container"][clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/parentPanel"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/customPanel"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/custom"][clickable=true] > android.widget.RelativeLayout[clickable=true] > android.widget.ImageView[id="com.autonavi.minimap:id/iv_close"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.widget.LinearLayout[clickable=true] > android.widget.FrameLayout[id="android:id/content"][clickable=true] > android.widget.LinearLayout[id="com.autonavi.minimap:id/root_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/fl_content_view"][clickable=true] > android.widget.FrameLayout[id="com.autonavi.minimap:id/widget_container"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
