      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout > android.widget.FrameLayout > android.view.ViewGroup[id="com.tencent.news:id/pop_dialog_root_view"] > android.widget.ScrollView[id="com.tencent.news:id/scroll_view"] > android.widget.LinearLayout[id="com.tencent.news:id/pop_dialog_main_content"] > android.widget.LinearLayout > android.widget.TextView[id="com.tencent.news:id/pop_dialog_positive_btn"][clickable=true]',
