...
export default defineGkdApp({
  ...
  groups: [
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/container"] > android.view.ViewGroup[id="com.ss.android.ugc.aweme.lite:id/cbn"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/cnm"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/is+"] > android.widget.Button[id="com.ss.android.ugc.aweme.lite:id/al-"][desc="关闭"][clickable=true]',
    ...
    {
      key: 1,
      name: 'in-app|nRAMw88NsU7exrcUi0hoUDV3XcBGlzVusJhjhUfEkow=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
      ...
      rules: [
        {
          ...
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/asf"] > android.widget.LinearLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/ar0"] > android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/arz"] > android.widget.FrameLayout > com.lynx.tasm.ui.image.UIImage[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.view.ViewGroup[id="com.ss.android.ugc.aweme.lite:id/ign"] > android.widget.LinearLayout[id="com.ss.android.ugc.aweme.lite:id/hdo"] > android.widget.TextView[id="com.ss.android.ugc.aweme.lite:id/agg"][text="我知道了"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/container"] > android.view.ViewGroup[id="com.ss.android.ugc.aweme.lite:id/cbn"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/cnm"] > android.widget.FrameLayout > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/cancel_btn"][desc="关闭"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    ...
    {
      key: 14,
      name: 'in-app|c84aV7Ozvau3fXvte_ZHO4XJxfgMy0__ZcS4Gk2lIlY=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
      ...
      rules: [
        {
          ...
          activityIds: 'com.ss.android.ugc.aweme.splash.SplashActivity',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/eci"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/kv4"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/eci"] > X.VgE[id="com.ss.android.ugc.aweme.lite:id/viewpager"] > android.widget.TabHost[id="com.ss.android.ugc.aweme.lite:id/hs9"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/hsw"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/mbc"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/d2n"] > android.view.ViewGroup[id="com.ss.android.ugc.aweme.lite:id/mrs"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/dyw"] > android.view.ViewGroup[id="com.ss.android.ugc.aweme.lite:id/viewpager"] > android.widget.FrameLayout > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/d1p"] > android.widget.FrameLayout > android.view.ViewGroup[id="com.ss.android.ugc.aweme.lite:id/a84"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/d1n"] > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/auc"] > android.widget.FrameLayout > android.widget.FrameLayout[id="com.ss.android.ugc.aweme.lite:id/arz"] > android.widget.FrameLayout > com.lynx.component.svg.UISvg[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
