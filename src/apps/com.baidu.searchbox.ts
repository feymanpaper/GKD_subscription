      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.baidu.searchbox:id/obfuscated"] > android.widget.RelativeLayout[id="com.baidu.searchbox:id/obfuscated"] > android.widget.LinearLayout[id="com.baidu.searchbox:id/obfuscated"] > android.widget.TextView[id="com.baidu.searchbox:id/obfuscated"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
