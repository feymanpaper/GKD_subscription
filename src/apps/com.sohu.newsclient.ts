      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.sohu.newsclient:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.LinearLayout > android.widget.LinearLayout[id="com.sohu.newsclient:id/ll_dialog_layout"] > android.widget.LinearLayout[id="com.sohu.newsclient:id/button_layout"] > android.widget.TextView[id="com.sohu.newsclient:id/tv_negative"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
