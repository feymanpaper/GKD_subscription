      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout > android.widget.RelativeLayout > android.widget.LinearLayout[id="com.qiyi.video:id/layout"] > android.widget.LinearLayout[id="com.qiyi.video:id/unused_res_a"] > android.widget.Button[id="com.qiyi.video:id/cancel_btn"][text="暂时不要"][clickable=true]',
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.RelativeLayout > android.widget.LinearLayout > android.widget.TextView[id="com.qiyi.video:id/right_button"][text="立即购买"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
