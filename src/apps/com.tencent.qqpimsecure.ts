      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.tencent.qqpimsecure:id/guide_root"] > android.widget.RelativeLayout > android.widget.FrameLayout[clickable=true] > android.widget.RelativeLayout > android.widget.LinearLayout[id="com.tencent.qqpimsecure:id/skip_style_with_info"] > android.widget.TextView[id="com.tencent.qqpimsecure:id/skip_time_change_tv"][clickable=true]',
      ...
      rules: [
        {
          ...
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.LinearLayout > android.widget.LinearLayout[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.RelativeLayout > android.widget.LinearLayout[id="com.tencent.qqpimsecure:id/ui_lib_dialog_confirm_msg_content_layout"] > android.widget.Button[id="com.tencent.qqpimsecure:id/ui_lib_dialog_button_right"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
