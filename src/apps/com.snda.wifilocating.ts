      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout[clickable=true] > android.view.ViewGroup[id="miui.systemui.plugin:id/detail_panel"][clickable=true] > android.widget.LinearLayout[id="miui.systemui.plugin:id/detail_container"][clickable=true] > android.widget.TextView[id="miui.systemui.plugin:id/more_button"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
