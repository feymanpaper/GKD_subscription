...
export default defineGkdApp({
  ...
  groups: [
    {
      key: 0,
      name: 'in-app|07gfglHKHoB8shfyRat-OxDUSarqP8p97WQbfFTqO2E=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 1,
      name: 'in-app|5urNl9VtHaeuAo3jbVIiN2FqvDW_z8eVwls3Z4xwkeI=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 2,
      name: 'in-app|gmaiKUsTKeXfhHz9tIqtQh47VYhqAXJtgqngSBuMrSg=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 3,
      name: 'in-app|66bQOGYUlaZ5LL-hBscAzjJaDf95pxkeYYDARXMSK4Q=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 4,
      name: 'in-app|yCkfiTAKZU5VS4C9dbtU6BAeiKYoXSMY-Lzw0A5wY-E=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 5,
      name: 'in-app|nHh0gwqoxjKjpu2ejX0b7PuFnbpwwEDsTy3wzT4PQgQ=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 6,
      name: 'in-app|PkpOwfHHqbUxatthfcUNJThFH_dT7kEXyKclKOcjIVQ=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 7,
      name: 'in-app|X9c2lvAAuh6FSxrMF7O6gN-FIKc9h-fsc_7EDAjyBWw=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 8,
      name: 'in-app|2C7dWyWE-4W9aG8xmJX0COgUG3iVfr9F6T_CsP4tOBA=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 9,
      name: 'in-app|Ocj3uaoMVDcjn26mCerA0nIEL8c-vFvVP9wczw7gGqk=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.shizhuang.duapp:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.view.ViewGroup > android.view.ViewGroup[id="com.shizhuang.duapp:id/topLayout"] > android.widget.TextView[id="com.shizhuang.duapp:id/iconClose"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    {
      key: 10,
      name: 'in-app|_d5P4S56-1dIi7wEIGb7g5COTVPcOsFZuySLH-7z5bA=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.view.ViewGroup > android.view.ViewGroup[id="com.shizhuang.duapp:id/clContent"] > android.widget.TextView[id="com.shizhuang.duapp:id/appStoreTv"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    {
      key: 11,
      name: 'in-app|3tQ9QZnAcA41nlcIIelNdacAl13f5wKhKhGq-6IKYH0=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 12,
      name: 'in-app|KPbeax1ArYh-1ZZ-mc3wX4EbjOkFWCWUIEEM80rvKSE=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
    ...
    {
      key: 13,
      name: 'in-app|nfjMmaecxViF2jPb3tHQ-uCuUpN47cxybR-g5UtSaQg=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="com.shizhuang.duapp:id/action_bar_root"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout > android.view.ViewGroup > android.widget.TextView[id="com.shizhuang.duapp:id/tvGoOpen"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    {
      key: 14,
      name: 'in-app|S0ZxR1byiZI7anvL84Ns3C8smlyq6UnM3VJzIFkUAeg=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.view.ViewGroup > android.widget.Button[id="com.shizhuang.duapp:id/closeIcon"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    {
      key: 15,
      name: 'in-app|VqlY4AeqU0GTPohvvnf4lY6rmkvG397qeL9AE8KCh4s=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.view.ViewGroup > android.widget.TextView[id="com.shizhuang.duapp:id/md_buttonDefaultPositive"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    {
      key: 16,
      name: 'in-app|PjD3hr6kLQCYAZz77h4EuDPrYEi-qzoyuDCetL8gpDA=.png',
      actionMaximum: 10,
      resetMatch: 'app',
      rules: [
        {
