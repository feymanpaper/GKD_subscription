...
export default defineGkdApp({
  id: 'com.jifen.qukan',
  name: 'com.jifen.qukan',
  groups: [
    {
      key: 0,
      name: 'in-app|-7PiW1wAxxeMzqPLPbtFECA8Jfr_LyTzW4uwQEwk_lU=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
    ...
    {
      key: 1,
      name: 'in-app|-PN1qo1IwW80Qq8mVR-ZEBShG_FmpDxaBLUtgPYeYIU=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
    ...
    {
      key: 4,
      name: 'in-app|5sV7yLI4pKTniMReTV96WF0gvSZpg13xRA7QEHuZf0U=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.RelativeLayout > android.widget.RelativeLayout[id="com.jifen.qukan:id/bde"] > android.widget.TextView[id="com.jifen.qukan:id/j6"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    {
      key: 5,
      name: 'in-app|8Oru0BuGRl0ng4KKdrpB5q2fUZZoUIdoz0M314tj_aQ=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
      ...
      rules: [
        {
          ...
          activityIds: 'com.jifen.qkbase.web.WebActivity',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout[id="com.jifen.qukan:id/bmf"] > android.widget.LinearLayout[id="com.jifen.qukan:id/bme"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.RelativeLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="com.jifen.qukan:id/il"] > android.widget.FrameLayout > android.widget.RelativeLayout[id="com.jifen.qukan:id/coi"] > android.widget.FrameLayout[id="com.jifen.qukan:id/cog"] > android.webkit.WebView > android.webkit.WebView[text="邀请好友赚金币"] > android.view.View[id="app"] > android.view.View > android.view.View > android.widget.TextView[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    {
      key: 6,
      name: 'in-app|9eusPg_iSWzmuX5pVzMGhS04Oz1H_iXweIMG08HSvJo=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
      ...
      rules: [
        {
          ...
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.RelativeLayout > android.widget.FrameLayout[id="com.jifen.qukan:id/e7"] > android.widget.LinearLayout[id="com.jifen.qukan:id/at8"] > android.widget.FrameLayout > android.widget.RelativeLayout > android.widget.FrameLayout > android.view.ViewGroup[id="com.jifen.qukan:id/coj"] > android.widget.FrameLayout[id="com.jifen.qukan:id/cog"] > android.webkit.WebView > android.webkit.WebView > android.view.View[id="app"] > android.view.View > android.view.View > android.widget.TextView[text="立即打卡"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    ...
    {
      key: 8,
      name: 'in-app|BiBJxl7VVrCeLw_lcMHq8rdmjlwVGxsrASs23ec88z8=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
      ...
      rules: [
        {
          ...
          activityIds: 'com.jifen.qkbase.web.WebActivity',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout[id="com.jifen.qukan:id/bmf"] > android.widget.LinearLayout[id="com.jifen.qukan:id/bme"] > android.widget.FrameLayout[id="android:id/content"] > android.widget.RelativeLayout > android.widget.LinearLayout > android.widget.FrameLayout[id="com.jifen.qukan:id/il"] > android.widget.FrameLayout > android.widget.RelativeLayout[id="com.jifen.qukan:id/coi"] > android.widget.FrameLayout[id="com.jifen.qukan:id/cog"] > android.webkit.WebView > android.webkit.WebView[text="存钱罐"] > android.view.View[id="app"] > android.view.View[clickable=true] > android.view.View > android.view.View > android.widget.TextView[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
    ...
    {
      key: 10,
      name: 'in-app|DgCRc1ceQUfRc3bePRKtpth54GRHBBRnoYzstk2Y5h0=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
    ...
    {
      key: 11,
      name: 'in-app|DyLv5kaSP7LnouHR3GmK3PTWsYbQKGbtUYRLlcKnLdg=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
    ...
    {
      key: 13,
      name: 'in-app|e_46OS3169oGuiGRDm2Bfm2-86s7G6h0J1BuIS_qjdk=.png',
      actionDelay: 3000,
      actionMaximum: 3,
      resetMatch: 'app',
      priorityTime: 10000,
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.LinearLayout > android.widget.RelativeLayout[id="com.jifen.qukan:id/bem"] > android.widget.RelativeLayout[id="com.jifen.qukan:id/at5"] > android.widget.TextView[id="com.jifen.qukan:id/ccu"][text="点击领钱"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.RelativeLayout > android.widget.TextView[id="com.jifen.qukan:id/cib"][text="先去逛逛"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
