      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.LinearLayout > com.baidu.searchbox.widget.SlidingPaneLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.FrameLayout[id="com.baidu.tieba:id/obfuscated"] > com.baidu.searchbox.widget.SlidingPaneLayout > android.widget.FrameLayout > android.widget.LinearLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.FrameLayout > android.widget.LinearLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.RelativeLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.LinearLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.RelativeLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.ImageView[id="com.baidu.tieba:id/obfuscated"][desc="菜单"][clickable=true]',
      ...
      rules: [
        {
          ...
          activityIds: '',
          matches:
            'android.widget.FrameLayout > android.widget.FrameLayout > android.widget.FrameLayout[id="android:id/content"] > android.widget.FrameLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.RelativeLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.LinearLayout[id="com.baidu.tieba:id/obfuscated"] > android.widget.TextView[id="com.baidu.tieba:id/obfuscated"][text="去认证"][clickable=true]',
          snapshotUrls: 'https://i.gkd.li/i/13183946',
        },
      ],
    },
